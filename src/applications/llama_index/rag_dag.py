...
with TaskDAG(id="test_rag", required_worker_tag="MM1"):
    ...
    condense >> [condense_predict_log, keyword, vector_retriever]

    keyword >> keyword_predict_log >> keyword_retriever >> vector_retriever
